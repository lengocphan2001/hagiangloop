...
@section('title', 'Edit Bus Service')

@section('content_header')
    <h1>Edit Bus Service: {{ $busService->name }}</h1>
@stop

@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.bus-services.update', $busService) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" 
                                   value="{{ old('name', $busService->name) }}" placeholder="e.g., VIP CABIN, LUXURY BUS" required>
                            @error('name')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="type" id="type" class="form-control @error('type') is-invalid @enderror" required>
                                ...
                                <option value="vip_cabin" {{ old('type', $busService->type) === 'vip_cabin' ? 'selected' : '' }}>VIP Cabin</option>
                                <option value="luxury_bus" {{ old('type', $busService->type) === 'luxury_bus' ? 'selected' : '' }}>Luxury Bus</option>
                                <option value="limousine_bus" {{ old('type', $busService->type) === 'limousine_bus' ? 'selected' : '' }}>Limousine Bus</option>
                            </select>
                            @error('type')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="departure_time" id="departure_time" class="form-control @error('departure_time') is-invalid @enderror" 
                                   value="{{ old('departure_time', $busService->departure_time) }}" placeholder="e.g., 11AM, 7:30PM" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="price" id="price" class="form-control @error('price') is-invalid @enderror" 
                                   value="{{ old('price', $busService->price) }}" min="0" step="1000" required>
                            @error('price')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="direction" id="direction" class="form-control @error('direction') is-invalid @enderror" required>
                                <option value="outbound" {{ old('direction', $busService->direction) === 'outbound' ? 'selected' : '' }}>Outbound</option>
                                <option value="return" {{ old('direction', $busService->direction) === 'return' ? 'selected' : '' }}>Return</option>
                            </select>
                            @error('direction')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="starting_point" id="starting_point" class="form-control @error('starting_point') is-invalid @enderror" 
                                   value="{{ old('starting_point', $busService->starting_point) }}" placeholder="e.g., HANOI">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="return_destination" id="return_destination" class="form-control @error('return_destination') is-invalid @enderror" 
                           value="{{ old('return_destination', $busService->return_destination) }}" placeholder="e.g., HA LONG">
                ...
                <div class="form-group">
                    ...
                    @if($busService->image)
                        <div class="mb-2">
                            <img src="{{ Storage::url($busService->image) }}" alt="{{ $busService->name }}" class="img-thumbnail" style="max-width: 200px; max-height: 200px; object-fit: cover;">
                        </div>
                    @endif
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="sort_order" id="sort_order" class="form-control @error('sort_order') is-invalid @enderror" 
                                   value="{{ old('sort_order', $busService->sort_order) }}">
                            @error('sort_order')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-check mt-4">
                                <input type="checkbox" name="is_recommended" id="is_recommended" class="form-check-input" value="1" 
                                       {{ old('is_recommended', $busService->is_recommended) ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div class="form-check mt-4">
                                <input type="checkbox" name="is_active" id="is_active" class="form-check-input" value="1" 
                                       {{ old('is_active', $busService->is_active) ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Update Bus Service
                    </button>
