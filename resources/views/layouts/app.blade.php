...
<body class="font-sans antialiased bg-white text-gray-900 overflow-x-hidden">
    <div id="app" class="min-h-screen flex flex-col">
        ...
        <div class="fixed bottom-6 right-6" style="width: 3.5rem; z-index: 9999; position: fixed; isolation: isolate;">
            <!-- Scroll to Top Button (bottom, fixed position) -->
            <button 
                id="scrollTopBtn"
                onclick="window.scrollTo({ top: 0, behavior: 'smooth' })"
                class="absolute bottom-0 right-0 w-12 h-12 rounded-full bg-amber-900 hover:bg-amber-800 text-white flex items-center justify-center shadow-lg"
            ...
            <a href="https://wa.me/84915121987" 
                target="_blank"
                class="floating-btn absolute bottom-[7.5rem] right-0 w-12 h-12 rounded-lg bg-[#25D366] hover:bg-[#20BA5A] flex items-center justify-center shadow-lg"
                style="transition: none !important; animation: none !important; transform: none !important;">
