            ...
            <form action="{{ route('admin.news.update', $news) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror" 
                           value="{{ old('slug', $news->slug) }}" placeholder="Auto-generated from title if empty">
                    @error('slug')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="excerpt" id="excerpt" class="form-control @error('excerpt') is-invalid @enderror" 
                              rows="3" maxlength="500">{{ old('excerpt', $news->excerpt) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <x-forms.tinymce-editor name="content" id="content" :value="old('content', $news->content)" />
                    @error('content')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    @if($news->featured_image)
                        <div class="mb-2">
                            ...
                            <p class="text-muted mt-1">Current featured image</p>
                        </div>
                    @endif
                    <input type="file" name="featured_image" id="featured_image" class="form-control @error('featured_image') is-invalid @enderror" 
                           accept="image/*">
                    <small class="form-text text-muted">Upload new image to replace current one. Recommended size: 1200x630px</small>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="meta_title" id="meta_title" class="form-control" 
                                   value="{{ old('meta_title', $news->meta_title) }}" maxlength="255">
                ...
                <div class="form-group">
                    ...
                    <textarea name="meta_description" id="meta_description" class="form-control" rows="3" maxlength="500">{{ old('meta_description', $news->meta_description) }}</textarea>
