...
@section('title', __('booking.title') . ' - Alley Homestay - Ha Giang Loop')
        ...
        <div class="container mx-auto px-4 lg:px-6 py-4 max-w-7xl">
            ...
            <div class="text-center mb-8 lg:mb-12">
                <div class="inline-block mb-4">
                    <div
                        class="flex items-center justify-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full shadow-lg border border-amber-200">
                ...
                <h1
                    class="text-4xl lg:text-6xl font-extrabold bg-gradient-to-r from-amber-600 via-amber-500 to-amber-400 bg-clip-text text-transparent mb-4">
                    {{ __('booking.title') }}
                </h1>
                <p class="text-lg lg:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">{{ __('booking.subtitle') }}
                </p>
            </div>
                ...
                <div class="flex items-start justify-center gap-0 min-w-max">
                    ...
                    <div class="flex items-start flex-shrink-0" id="step1-indicator">
                        <div class="flex flex-col items-center">
                            <div
                                class="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 rounded-full bg-amber-500 text-white flex items-center justify-center font-bold text-xs sm:text-sm lg:text-base border-2 sm:border-4 border-white shadow-lg step-circle active flex-shrink-0">
                                1
                            </div>
                            <span
                                class="mt-1 sm:mt-2 text-[9px] sm:text-[10px] lg:text-xs font-medium text-gray-700 text-center whitespace-nowrap leading-tight px-0.5">{{ __('booking.select_tour') }}</span>
                        </div>
                        <div
                            class="w-6 sm:w-12 md:w-16 lg:w-24 h-1 bg-gray-200 step-line mt-4 sm:mt-5 lg:mt-6 flex-shrink-0">
                        </div>
                    </div>
                    ...
                    <div class="flex items-start flex-shrink-0" id="step2-indicator">
                        <div class="flex flex-col items-center">
                            <div
                                class="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 rounded-full bg-gray-300 text-gray-600 flex items-center justify-center font-bold text-xs sm:text-sm lg:text-base border-2 sm:border-4 border-white shadow-lg step-circle flex-shrink-0">
                                2
                            </div>
                            <span
                                class="mt-1 sm:mt-2 text-[9px] sm:text-[10px] lg:text-xs font-medium text-gray-500 text-center whitespace-nowrap leading-tight px-0.5">{{ __('booking.select_date') }}</span>
                        </div>
                        <div
                            class="w-6 sm:w-12 md:w-16 lg:w-24 h-1 bg-gray-200 step-line mt-4 sm:mt-5 lg:mt-6 flex-shrink-0">
                        </div>
                    ...
                    <div class="flex items-start flex-shrink-0" id="step3-indicator">
                        <div class="flex flex-col items-center">
                            ...
                            <span
                                class="mt-1 sm:mt-2 text-[9px] sm:text-[10px] lg:text-xs font-medium text-gray-500 text-center whitespace-nowrap leading-tight px-0.5">{{ __('booking.bus_services') }}</span>
                        </div>
                        <div
                            class="w-6 sm:w-12 md:w-16 lg:w-24 h-1 bg-gray-200 step-line mt-4 sm:mt-5 lg:mt-6 flex-shrink-0">
                        </div>
                    ...
                    <div class="flex items-start flex-shrink-0" id="step4-indicator">
                        <div class="flex flex-col items-center">
                            ...
                            <span
                                class="mt-1 sm:mt-2 text-[9px] sm:text-[10px] lg:text-xs font-medium text-gray-500 text-center whitespace-nowrap leading-tight px-0.5">{{ __('booking.summary') }}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white/90 backdrop-blur-lg overflow-visible rounded-2xl shadow-2xl border border-white/50">
                    ...
                    <div id="step1" class="step-content p-6 lg:p-10">
                        <div class="flex items-center gap-3 sm:gap-4 mb-8">
                            <div class="flex-shrink-0">
                                <div
                                    class="w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center shadow-lg">
                                    <span class="text-xl sm:text-2xl font-bold text-white">1</span>
                                </div>
                            </div>
                            <div class="flex-1 min-w-0">
                                <h2 class="text-lg sm:text-2xl lg:text-3xl font-bold text-gray-900 break-words">
                                    {{ __('booking.step') }} 1: {{ __('booking.select_tour') }}</h2>
                                <p class="text-xs sm:text-sm lg:text-base text-gray-500 mt-1 break-words">
                                    {{ __('booking.select_tour_description') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="max-w-2xl mx-auto">
                            ...
                            <div class="relative z-50">
                                <button type="button" id="tourSelectBtn"
                                    ...
                                    <svg class="w-5 h-5 text-gray-400 transition-transform" id="tourSelectIcon" fill="none"
                                        stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M19 9l-7 7-7-7"></path>
                                    </svg>
                                </button>
                                <div id="tourSelectDropdown"
                                    class="hidden absolute z-[60] w-full mt-1 bg-white border-2 border-gray-300 rounded-lg shadow-xl overflow-hidden max-h-[60vh] sm:max-h-96 overflow-y-auto">
                                    <div class="py-1" id="tourSelectOptions">
                                        @foreach($tours as $tour)
                                            <button type="button"
                                                class="w-full px-4 py-3 text-left text-sm text-gray-700 hover:bg-amber-50 hover:text-amber-600 transition-colors flex items-start gap-3 tour-option cursor-pointer"
                                                data-tour-id="{{ $tour->id }}" data-tour-slug="{{ $tour->slug }}"
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <div class="text-xs text-gray-500 mb-1">{{ $tour->days }}
                                                        {{ __('tours_index.days') }} / {{ $tour->nights }}
                                                        {{ __('tours_index.nights') }}</div>
                                                </div>
                                            </button>
                                        @endforeach
                                    </div>
                            ...
                            <div id="selectedTourPreview"
                                class="hidden mt-6 p-6 bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl border-2 border-amber-300 shadow-lg">
                                <div class="flex items-start gap-4">
                                    ...
                                    <button type="button" onclick="clearTourSelection()"
                                        class="flex-shrink-0 w-8 h-8 rounded-lg bg-white hover:bg-gray-100 flex items-center justify-center text-gray-400 hover:text-gray-600 transition-colors shadow-sm cursor-pointer">
                    ...
                    <div id="step2" class="step-content hidden p-6 lg:p-10">
                        <div class="mb-8">
                            <button onclick="previousStep(1)"
                                class="flex items-center gap-2 px-4 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors cursor-pointer">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="flex items-center gap-3 sm:gap-4 mb-8">
                            <div class="flex-shrink-0">
                                <div
                                    class="w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-500 flex items-center justify-center shadow-lg">
                                    <span class="text-xl sm:text-2xl font-bold text-white">2</span>
                                </div>
                            </div>
                            <div class="flex-1 min-w-0">
                                <h2 class="text-lg sm:text-2xl lg:text-3xl font-bold text-gray-900 break-words">
                                    {{ __('booking.step') }} 2: {{ __('booking.select_date') }}</h2>
                                <p class="text-xs sm:text-sm lg:text-base text-gray-500 mt-1 break-words">
                                    {{ __('booking.select_date_description') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-3">
                                        <svg class="w-5 h-5 inline mr-2 text-amber-500" fill="currentColor"
                                            viewBox="0 0 20 20">
                                            <path
                            ...
                            <div
                                class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-6 lg:p-8 border-2 border-gray-200 shadow-lg">
                                <div class="flex items-center gap-3 mb-6">
                                    <div
                                        class="w-10 h-10 rounded-xl bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center">
                                        <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd"
                        ...
                        <div class="mt-8 flex justify-between">
                            <button onclick="previousStep(1)"
                                class="group px-6 py-3 border-2 border-gray-300 text-gray-700 font-semibold rounded-xl hover:bg-gray-50 transition-all duration-200 flex items-center gap-2 shadow-sm hover:shadow-md">
                                <svg class="w-5 h-5 group-hover:-translate-x-1 transition-transform" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M15 19l-7-7 7-7"></path>
                    ...
                    <div id="step3" class="step-content hidden p-6 lg:p-10">
                        ...
                        <div class="flex items-center justify-between gap-3 sm:gap-4 mb-8">
                            <div class="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                                <div class="flex-shrink-0">
                                    <div
                                        class="w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-teal-500 to-cyan-500 flex items-center justify-center shadow-lg">
                                        <span class="text-xl sm:text-2xl font-bold text-white">3</span>
                                    </div>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <h2 class="text-lg sm:text-2xl lg:text-3xl font-bold text-gray-900 break-words">
                                        {{ __('booking.step') }} 3: {{ __('booking.bus_services') }} &
                                        {{ __('booking.gifts') }}</h2>
                                    <p class="text-xs sm:text-sm lg:text-base text-gray-500 mt-1 break-words">
                                        {{ __('booking.bus_services_gifts_description') }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-8">
                            ...
                            <div>
                                <div
                                    class="flex items-center gap-3 p-4 border-2 border-gray-300 rounded-lg hover:border-amber-400 transition-colors">
                                    ...
                                    <label for="useBusService" class="flex items-center gap-2 cursor-pointer flex-1">
                                        <svg class="w-6 h-6 text-amber-500 flex-shrink-0" fill="currentColor"
                                            viewBox="0 0 20 20">
                                            <path
                                ...
                                <div id="busServiceSection" class="hidden mt-6 space-y-6">
                                    ...
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 mb-2 leading-tight">{{ __('tours.select_starting_point') }}</label>
                                        <div class="mb-3 relative">
                                            <button type="button" id="busStartingPointBtn"
                                                ...
                                                <span id="busStartingPointText"
                                                    class="text-gray-700">{{ __('common.select') }}</span>
                                            ...
                                            <div id="busStartingPointDropdown"
                                                class="hidden absolute z-50 w-full mt-1 bg-white border-2 border-gray-300 rounded-lg shadow-xl overflow-hidden max-h-60 overflow-y-auto">
                                    ...
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 mb-2 leading-tight">{{ __('tours.choose_return_destination') }}</label>
                                        <div class="mb-3 relative">
                                            <button type="button" id="busReturnDestinationBtn"
                                                class="w-full min-h-[48px] px-4 py-3 text-left border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none bg-white flex items-center justify-between cursor-pointer hover:border-amber-400 transition-colors">
                                                <span id="busReturnDestinationText"
                                                    class="text-gray-700">{{ __('common.select') }}</span>
                                                <svg class="w-5 h-5 text-gray-400 transition-transform"
                            ...
                            <div>
                                ...
                                <div id="giftOptions"
                                    class="flex gap-4 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-amber-300 scrollbar-track-gray-100">
                        ...
                        <div class="mt-8 flex justify-between">
                            <button onclick="previousStep(2)"
                                class="group px-6 py-3 border-2 border-gray-300 text-gray-700 font-semibold rounded-xl hover:bg-gray-50 transition-all duration-200 flex items-center gap-2 shadow-sm hover:shadow-md cursor-pointer">
                                <svg class="w-5 h-5 group-hover:-translate-x-1 transition-transform" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M15 19l-7-7 7-7"></path>
                    ...
                    <div id="step4" class="step-content hidden p-6 lg:p-10">
                        ...
                        <div class="flex items-center gap-3 sm:gap-4 mb-8">
                            <div class="flex-shrink-0">
                                <div
                                    class="w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center shadow-lg">
                                    <span class="text-xl sm:text-2xl font-bold text-white">4</span>
                                </div>
                            </div>
                            <div class="flex-1 min-w-0">
                                <h2 class="text-lg sm:text-2xl lg:text-3xl font-bold text-gray-900 break-words">
                                    {{ __('booking.step') }} 4: {{ __('booking.summary') }}</h2>
                                <p class="text-xs sm:text-sm lg:text-base text-gray-500 mt-1 break-words">
                                    {{ __('booking.summary_description') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                            ...
                            <div class="lg:col-span-2 space-y-6 w-full">
                                <div
                                    class="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-4 sm:p-6 lg:p-8 border-2 border-gray-200 shadow-lg w-full overflow-hidden">
                                    <div class="flex items-center gap-3 mb-6">
                                        <div
                                        ...
                                        <h3 class="text-xl font-bold text-gray-900">{{ __('checkout.booking_details') }}
                                        </h3>
                                    </div>
                            ...
                            <div class="lg:col-span-1">
                                <div
                                    class="bg-gradient-to-br from-amber-50 via-amber-50 to-amber-100 rounded-2xl p-4 lg:p-6 border-2 border-amber-300 shadow-xl sticky top-4">
                                    ...
                                    <div class="mb-4 p-3 bg-white/60 backdrop-blur-sm rounded-xl border border-amber-200">
                                        <div class="flex items-center justify-between gap-2">
                                            <span
                                                class="text-sm font-semibold text-gray-700">{{ __('common.total') }}:</span>
                                            <span class="text-xl lg:text-2xl font-bold text-amber-600 break-words"
                                                id="bookingTotal">0 VND</span>
                                        </div>
                                    </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            async function selectTour(tourId, tourSlug, tourName, element) {
                ...
                try {
                    ...
                    if (tourInfo.price) {
                        ...
                        bookingData.tourNights = parseInt(tourInfo.nights) || 0;
            ...
            function clearTourSelection() {
                ...
                bookingData.tourPrice = 0;
                bookingData.tourNights = 0;
            ...
            function calculateTotal() {
                ...
                // Accommodation price is per night and must be multiplied by the selected tour nights.
                if (bookingData.selectedAccommodation && bookingData.accommodationPrice > 0) {
                    ...
                    const tourNights = Math.max(0, parseInt(bookingData.tourNights) || 0);
                    const accommodationTotal = accommodationPrice * tourNights;
                    total += accommodationTotal;
                    console.log('Accommodation price/night:', accommodationPrice, 'Nights:', tourNights, 'Accommodation total:', accommodationTotal);
                }
            ...
            // Ensure stale flag from previous versions does not trigger unintended scroll behavior.
