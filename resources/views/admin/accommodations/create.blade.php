...
@section('content_header')
    <h1>Create New Accommodation</h1>
@stop
            ...
            <form action="{{ route('admin.accommodations.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" 
                           value="{{ old('name') }}" required placeholder="e.g., Dorm, Private room (1-2pp), Family room (3-4pp)">
                    @error('name')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="capacity_min" id="capacity_min" class="form-control @error('capacity_min') is-invalid @enderror" 
                                   value="{{ old('capacity_min', 1) }}" min="1" required>
                            @error('capacity_min')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="capacity_max" id="capacity_max" class="form-control @error('capacity_max') is-invalid @enderror" 
                                   value="{{ old('capacity_max', 2) }}" min="1" required>
                            @error('capacity_max')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="bed_type" id="bed_type" class="form-control @error('bed_type') is-invalid @enderror" 
                           value="{{ old('bed_type') }}" placeholder="e.g., 1 king bed, 2 king beds">
                    @error('bed_type')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="price_per_night" id="price_per_night" class="form-control @error('price_per_night') is-invalid @enderror" 
                           value="{{ old('price_per_night', 0) }}" min="0" required>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Create Accommodation
                    </button>
