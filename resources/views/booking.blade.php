                ...
                <div id="step1" class="step-content p-6 lg:p-10">
                    <div class="flex items-center gap-3 sm:gap-4 mb-8">
                        ...
                        <div class="flex-1 min-w-0">
                            <h2 class="text-lg sm:text-2xl lg:text-3xl font-bold text-gray-900 break-words">{{ __('booking.step') }} 1: {{ __('booking.select_tour') }}</h2>
                            <p class="text-xs sm:text-sm lg:text-base text-gray-500 mt-1 break-words">{{ __('booking.select_tour_description') }}</p>
                        </div>
                    </div>
                ...
                <div id="step3" class="step-content hidden p-6 lg:p-10">
                    <div class="flex items-center justify-between gap-3 sm:gap-4 mb-8">
                        <div class="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                            ...
                            <div class="flex-1 min-w-0">
                                <h2 class="text-lg sm:text-2xl lg:text-3xl font-bold text-gray-900 break-words">{{ __('booking.step') }} 3: {{ __('booking.bus_services') }} & {{ __('booking.gifts') }}</h2>
