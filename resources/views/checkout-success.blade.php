...
@section('title', 'Order Confirmed - Alley Homestay - Ha Giang Loop')
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 mb-6 text-left">
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span
                                    class="font-medium text-gray-900">{{ $order->tour_start_date->format('d/m/Y') }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">People:</span>
                                <span class="font-medium text-gray-900">{{ $order->adults_count }}
                                    Adult(s){{ $order->children_count > 0 ? ', ' . $order->children_count . ' Child(ren)' : '' }}</span>
                            </div>
                            ...
                            <div class="pt-3 border-t border-gray-200">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        class="text-xl font-bold text-pink-600">{{ number_format($order->total_price, 0, ',', '.') }}
                                        VND</span>
                                </div>
                            </div>
                        </div>
