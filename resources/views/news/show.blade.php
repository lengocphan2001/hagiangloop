...
@section('content')
<!-- Hero Section -->
<section class="relative bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 overflow-hidden news-detail-hero-section">
    @if($newsItem->featured_image)
        <div class="absolute inset-0">
            <img src="{{ Storage::url($newsItem->featured_image) }}" alt="{{ $newsItem->title }}" class="w-full h-full object-cover opacity-20">
        </div>
    @endif
    ...
    <div class="container mx-auto px-4 lg:px-6">
        <div class="max-w-4xl mx-auto">
            <div class="flex items-center justify-between text-sm text-gray-500">
                ...
                <a href="{{ route('news.index') }}" class="text-blue-600 hover:text-blue-700 font-semibold flex items-center gap-1">
        ...
        <div class="container mx-auto px-4 lg:px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                @foreach($relatedNews as $item)
                    <article class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow cursor-pointer"
